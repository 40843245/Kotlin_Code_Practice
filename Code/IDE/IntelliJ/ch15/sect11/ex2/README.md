...
### code
    ...
    internal class SampleTest {
        ...
        public fun testSum()
        {
            val expected : Any? = false;
            println(expected);
            assertIsNot<Int>(expected );
        }
    }
