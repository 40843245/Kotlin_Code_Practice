...
### code
    ...
    internal class SampleTest {
        ...
        public fun testSum()
        {
            val expected = List<String> (5) {"Hello World"};
            println(expected);
            assertIsNot<List<String>>(expected );
        }
    }
...
### output
    ...
    Exception in thread "main" java.lang.AssertionError: Expected value to not be of type <java.util.List<java.lang.String> (Kotlin reflection is not available)>.
    	...
    	at kotlin.test.AssertionsKt__AssertionsKt.assertIsNotOfType(Assertions.kt:139)
    	at kotlin.test.AssertionsKt.assertIsNotOfType(Unknown Source)
