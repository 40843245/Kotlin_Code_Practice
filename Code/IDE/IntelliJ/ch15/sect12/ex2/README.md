...
### code
    ...
    internal class SampleTest {
        ...
        public fun testSum()
        {
            ...
            val realValue : List<String> = List<String> (5) {"Hello"};
            println(expected);
