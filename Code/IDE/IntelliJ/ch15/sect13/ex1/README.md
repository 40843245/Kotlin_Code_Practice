...
### code
    ...
    internal class SampleTest {
        ...
        public fun testSum()
        {
            ...
            val realValue : List<Int> = List<Int> (5) {expected.get(it); };
            println(expected);
