...
### code
    ...
    internal class SampleTest {
        ...
        {
            println(expected);
            expect<List<Int>>(expected,{ List<Int>(expected.size) {it * 2} } );
        }
    }
