...
### output
    ...
    Collection <[0, 2, 4, 6, 8]>, element <10>.
    	...
    	at kotlin.test.AssertionsKt__AssertionsKt.assertContains(Assertions.kt:165)
    	at kotlin.test.AssertionsKt.assertContains(Unknown Source)
    	at kotlin.test.AssertionsKt__AssertionsKt.assertContains$default(Assertions.kt:164)
    	at kotlin.test.AssertionsKt.assertContains$default(Unknown Source)
