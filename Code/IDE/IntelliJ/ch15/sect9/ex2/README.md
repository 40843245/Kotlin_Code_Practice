...
### output
    ...
    Exception in thread "main" java.lang.AssertionError: assertTrue
    	...
    	at kotlin.test.DefaultAsserter.assertTrue(DefaultAsserter.kt:11)
    	at SampleTest.testSum(Main.kt:20)
