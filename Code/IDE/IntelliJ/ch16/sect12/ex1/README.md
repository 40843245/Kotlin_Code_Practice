...
### code
    fun main() {
        ...
        println("Retain all elements which is greater than or equal to 3.")
        println(numbers)
        numbers.clear()
        println("Clear.")
        println(numbers)
