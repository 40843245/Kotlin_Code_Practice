...
### code
    fun main() {
        ...
        val simpleSum = numbers.reduceRight { sum, element -> sum + element * 2 }
        println(simpleSum)
        val sumDoubled = numbers.foldRight(0) { sum, element -> sum + element * 2  }
        println(sumDoubled)
